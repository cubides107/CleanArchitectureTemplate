...
namespace CleanArchitecture.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250510203439_InitialV2")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Customers.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Address", "CleanArchitecture.Domain.Customers.Entities.Customer.Address#Address", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("CleanArchitecture.Domain.Products.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("494a3029-c45e-48b2-b646-a5792867c237"),
                        ...
                        new
                        {
                            Id = new Guid("1e45d172-b493-43a9-8c5e-f50cb9409c6f"),
                            Description = "Producto de Prueba",
                            Name = "Producto 2",
                            Price = 5000m,
                            Stock = 4
